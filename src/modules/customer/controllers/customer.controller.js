...
const customerController = {
    ...
    createCustomer: asyncHandler(async (req, res) => {
        ...
        // Beneficiarios son opcionales al crear cliente.
        // La validación de mínimo 3 beneficiarios se aplica al crear la venta del nicho.
    ...
    /**
     * ACTUALIZAR BENEFICIARIOS (LEGACY - embebidos en Customer)
     * PUT /api/customers/:id/beneficiaries
     * @deprecated Usar PUT /api/beneficiaries/niche/:nicheId para beneficiarios por nicho
     */
    ...
    /**
     * MARCAR BENEFICIARIO COMO FALLECIDO (LEGACY - embebidos en Customer)
     * POST /api/customers/:id/beneficiaries/:beneficiaryId/deceased
     * @deprecated Usar POST /api/beneficiaries/:id/deceased para beneficiarios independientes
     */
    ...
    /**
     * OBTENER PRÓXIMO BENEFICIARIO VIVO (LEGACY - embebidos en Customer)
     * GET /api/customers/:id/next-beneficiary
     * @deprecated Usar GET /api/beneficiaries/niche/:nicheId/next para beneficiarios por nicho
     */
