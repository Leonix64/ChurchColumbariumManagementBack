...
const Payment = require('../../modules/sale/models/payment.model');

/**
 * SEED MEJORADO PARA PRUEBAS DE VENTA
 * VersiÃ³n interactiva con opciones personalizables
 */
...
const SALE_CONFIG = {
    ...
    // Â¿Crear nuevo cliente o usar uno existente?
    ...
    newCustomerData: {
        ...
        beneficiaries: ['Roberto SÃ¡nchez', 'MarÃ­a SÃ¡nchez']
    }
};
...
/**
 * Formatea nÃºmeros a moneda mexicana
 */
...
/**
 * Calcula la tabla de amortizaciÃ³n
 */
...
/**
 * Imprime una tabla de amortizaciÃ³n bonita
 */
const printAmortizationTable = (table) => {
    console.log('\nðŸ“… TABLA DE AMORTIZACIÃ“N:');
    console.log('â”€'.repeat(60));
    console.log('  # â”‚ Fecha Vencimiento â”‚ Monto a Pagar â”‚ Estado');
    console.log('â”€'.repeat(60));
    ...
    table.slice(0, 5).forEach(payment => {
        ...
        console.log(
            `  ${String(payment.number).padStart(2)} â”‚ ${dateStr.padEnd(17)} â”‚ ${formatMoney(payment.amount).padEnd(13)} â”‚ ${payment.status}`
        );
    });
...
const testSaleFlow = async () => {
    ...
    try {
        ...
        console.log('ðŸ›ï¸  SISTEMA DE VENTA DE NICHOS - PRUEBA COMPLETA'.padStart(50));
        console.log('â•'.repeat(70));
        console.log('');
        ...
        if (SALE_CONFIG.createNewCustomer) {
            ...
            if (!customer) {
                throw new Error('âŒ No hay clientes disponibles. Ejecuta: npm run seed:customers');
            }
            console.log('   âœ… Cliente seleccionado de la base de datos');
        }
        ...
        // ========================================
        console.log('\nðŸ›ï¸  PASO 2: SELECCIÃ“N DE NICHO');
        console.log('â”€'.repeat(70));
        ...
        if (!niche) {
            throw new Error('âŒ No hay nichos disponibles con esos criterios');
        }

        console.log('');
        console.log('   âœ… Nicho encontrado:');
        console.log('   CÃ³digo:       ' + niche.code);
        console.log('   NÃºmero:       #' + niche.displayNumber);
        console.log('   UbicaciÃ³n:    MÃ³dulo ' + niche.module + ', SecciÃ³n ' + niche.section + ', Fila ' + niche.row);
        console.log('   Tipo:         ' + (niche.type === 'wood' ? 'ðŸªµ Madera' : 'ðŸ’Ž MÃ¡rmol'));
        console.log('   Precio:       ' + formatMoney(niche.price));
        console.log('   ID:           ' + niche._id);

        // ========================================
        // PASO 3: CÃLCULOS FINANCIEROS
        // ========================================
        console.log('\nðŸ’° PASO 3: CÃLCULOS FINANCIEROS');
        console.log('â”€'.repeat(70));
        ...
        console.log('   Tasa de InterÃ©s:        0% (sin intereses)');
        ...
        // ========================================
        console.log('\nðŸ’³ PASO 5: REGISTRO DE PAGO INICIAL');
        console.log('â”€'.repeat(70));
        ...
        console.log('   MÃ©todo:         ' + (createdPayment.method === 'cash' ? 'ðŸ’µ Efectivo' : 'ðŸ’³ Tarjeta'));
        ...
        // ========================================
        console.log('\nðŸ”„ PASO 6: ACTUALIZACIÃ“N DE NICHO');
        console.log('â”€'.repeat(70));
        ...
        console.log('   âœ… Nicho actualizado exitosamente');
        console.log('');
        console.log('   CÃ³digo:         ' + niche.code);
        console.log('   Estado:         available â†’ sold');
        console.log('   Propietario:    ' + customer.firstName + ' ' + customer.lastName);

        // ========================================
        // PASO 7: CONFIRMAR TRANSACCIÃ“N
        // ========================================
        console.log('\nâœ… PASO 7: CONFIRMACIÃ“N DE TRANSACCIÃ“N');
        console.log('â”€'.repeat(70));

        await session.commitTransaction();
        console.log('   âœ… Todos los cambios confirmados exitosamente');
        ...
        console.log('\n');
        console.log('â•'.repeat(70));
        console.log('ðŸŽ‰ VENTA COMPLETADA EXITOSAMENTE'.padStart(50));
        console.log('â•'.repeat(70));
        console.log('');
        console.log('ðŸ“Š RESUMEN DE LA TRANSACCIÃ“N:');
        console.log('');
        console.log('   Cliente:        ' + customer.firstName + ' ' + customer.lastName);
        console.log('   TelÃ©fono:       ' + customer.phone);
        console.log('');
        console.log('   Nicho:          ' + niche.code + ' (#' + niche.displayNumber + ')');
        console.log('   UbicaciÃ³n:      MÃ³dulo ' + niche.module + ', SecciÃ³n ' + niche.section);
        console.log('   Tipo:           ' + (niche.type === 'wood' ? 'ðŸªµ Madera' : 'ðŸ’Ž MÃ¡rmol'));
        console.log('');
        ...
        console.log('   PrÃ³ximo Pago:   ' + amortizationTable[0].dueDate.toLocaleDateString('es-MX'));
        console.log('');
        console.log('â•'.repeat(70));
        console.log('');
        ...
        // DATOS PARA TESTING
        // ========================================
        console.log('ðŸ“ DATOS PARA PRUEBAS EN API:');
        console.log('');
        ...
        try {
            ...
            console.log('ðŸ”„ TransacciÃ³n revertida exitosamente');
        } catch (abortError) {
            console.error('âŒ Error al revertir transacciÃ³n:', abortError.message);
        }
        ...
        try {
            ...
            console.error('âŒ Error al cerrar conexiÃ³n:', closeError.message);
        }
    }
};
